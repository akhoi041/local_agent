...
| 0.6.0 Beta | `dev_notes/pipelines/TALOS_PIPELINE_060.md` | Active architecture foundation release for adapter contract, local API/IPC, native-helper boundary, Python fallback boundary, and shell migration decision. |
