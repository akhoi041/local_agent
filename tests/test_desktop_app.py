...
class TalosArduinoTests(unittest.TestCase):
    ...
    def test_frontend_contains_codex_workbench_panel(self) -> None:
        ...
        self.assertIn('id="editorMoreBtn"', html)
        self.assertIn('id="editorMoreMenu"', html)
        ...
        self.assertIn("syncEditorMoreMenu", script)
        self.assertIn("closeEditorMoreMenu", script)
        ...
        self.assertIn("@container (max-width: 800px)", styles)
        self.assertIn(".editor-more-menu", styles)
