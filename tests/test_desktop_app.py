...
class TalosArduinoTests(unittest.TestCase):
    ...
    def test_frontend_contains_codex_workbench_panel(self) -> None:
        ...
        self.assertIn("COMMAND_PALETTE_ITEMS", script)
        self.assertIn("showCommandPalette", script)
        self.assertIn("renderCommandPalette", script)
        self.assertIn("commandPaletteOpen", script)
        self.assertIn("runCommandPaletteSelection", script)
        self.assertIn('event.shiftKey && event.key.toLowerCase() === "p"', script)
        self.assertIn("renderStatusBar", script)
        self.assertIn("#statusWorkspace", script)
        self.assertIn("#statusCodex", script)
        self.assertIn("toggleAppMenu", script)
        self.assertIn("closeAppMenus", script)
        self.assertIn("runAppMenuCommand", script)
        self.assertIn('$("#commandCenterBtn")?.addEventListener("click"', script)
        ...
        self.assertIn('button.addEventListener("mouseenter"', script)
        self.assertIn('if ($(".app-menu.open")) toggleAppMenu(button.dataset.menuButton)', script)
        ...
        self.assertIn('id="statusWorkspace"', html)
        self.assertIn('id="statusFile"', html)
        self.assertIn('id="statusBoard"', html)
        self.assertIn('id="statusVerify"', html)
        self.assertIn('id="statusCodex"', html)
        self.assertIn('id="commandCenterBtn"', html)
        self.assertIn('class="command-center"', html)
        self.assertIn("Search commands...", html)
        self.assertIn('data-command="command-palette"', html)
        ...
        self.assertIn(".command-center", style)
        self.assertIn("grid-template-columns: auto auto minmax(240px, 1fr) auto;", style)
        self.assertIn("justify-self: center;", style)
        self.assertIn("--statusbar-height", style)
        self.assertIn("inset: 42px 0 var(--statusbar-height);", style)
        self.assertIn(".command-palette-overlay", style)
        self.assertIn(".command-palette", style)
        self.assertIn(".command-palette-item", style)
        self.assertIn(".command-palette-item.active", style)
        self.assertIn(".status-bar", style)
        self.assertIn(".status-item", style)
        self.assertNotIn(".app-menu:nth-last-child", style)
        ...
        self.assertNotIn("restoreBoundsForDrag", script)
        self.assertNotIn("showTitlebarSnapMenu", script)
        self.assertNotIn("titlebar-snap", script)
        self.assertNotIn(".snap-menu", styles)
        self.assertNotIn("snap-option", html)
        self.assertNotIn('id="snapMenu"', html)
        self.assertNotIn('class="native-window"', html)
        self.assertNotIn("body.native-window .chrome-actions", styles)
        self.assertNotIn("body.native-window .window-resize-handle", styles)
