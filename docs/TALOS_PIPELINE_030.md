...
- [x] Decide whether project docs and helper scripts should default to pipeline 0.3.0 during development. `scripts/pipeline_status.ps1` now defaults to `docs/TALOS_PIPELINE_030.md`, while 0.1.0 and 0.2.0 pipeline files remain frozen version records.
...
- [x] Run pipeline status for `docs/TALOS_PIPELINE_030.md`.
...
- [x] Add or update a short 0.3.0 baseline note if any known carry-over risk exists. Added `docs/TALOS_030_BASELINE.md`.
